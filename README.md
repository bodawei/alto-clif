...
_See code: [src/commands/command.ts](https://github.com/oclif/oclif/blob/v1.16.1/src/commands/command.ts)_
...
_See code: [src/commands/hook.ts](https://github.com/oclif/oclif/blob/v1.16.1/src/commands/hook.ts)_
...
_See code: [src/commands/multi.ts](https://github.com/oclif/oclif/blob/v1.16.1/src/commands/multi.ts)_
...
_See code: [src/commands/plugin.ts](https://github.com/oclif/oclif/blob/v1.16.1/src/commands/plugin.ts)_
...
_See code: [src/commands/single.ts](https://github.com/oclif/oclif/blob/v1.16.1/src/commands/single.ts)_
<!-- commandsstop -->
